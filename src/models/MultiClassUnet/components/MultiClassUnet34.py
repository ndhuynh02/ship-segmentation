...
class MultiClassUnet34(torch.nn.Module):
    def __init__(self, n_classes=3, ckpt_path=None, arch=None, fixed_encoder=False):
        super().__init__()
        ...
        self.up5 = torch.nn.ConvTranspose2d(256, n_classes, 2, stride=2)
