...
from src.models.unet3p_pytorch.utils.weights_init import weights_init
...
class UNet3Plus(nn.Module):
    def __init__(
        ...
        self.decoder = U3PDecoder(
            self.encoder.channels[1:], skip_ch=skip_ch, dropout=dropout, fast_up=fast_up
        )
        ...
        if aux_losses > 0:
            ...
            self.aux_head.apply(weights_init)
        else:
            self.aux_head = None
