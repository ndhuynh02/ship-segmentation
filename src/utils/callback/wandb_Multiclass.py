...
from src.utils.airbus_utils import mask_overlay, multi_class_mask_overlay
...
class Callback(Callback):
    ...
    def on_validation_batch_end(
        ...
        for img, pred, target, id in zip(images, preds_new_c, labels_new_c, file_ids):
            if self.n_remained_images <= 0:
                break
            ...
            log_pred = multi_class_mask_overlay(img, pred)
            log_target = multi_class_mask_overlay(img, target)
