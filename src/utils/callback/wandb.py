...
from src.utils.airbus_utils import mask_overlay, masks_as_image, rle_decode
...
class WandbCallback(Callback):
    def __init__(self, image_id: str = '003b48a9e.jpg', data_path: str = 'data/airbus', n_images_to_log: int = 5):
        ...
        dataframe = pd.read_csv(os.path.join(
            data_path, 'train_ship_segmentations_v2.csv'))
        self.sample_mask = dataframe[dataframe['ImageId']
                                     == image_id]['EncodedPixels']
        ...
        self.df = pd.read_csv("data/airbus/train_ship_segmentations_v2.csv")
        self.colors = [(0, 255, 0), (255, 0, 0), (0, 0, 255), (255, 0, 255), (255, 255, 0), (0, 255, 255)]
    ...
    def on_train_epoch_end(self, trainer: "pl.Trainer", pl_module: "pl.LightningModule"):
        ...
        wandb_logger = trainer.logger
        wandb_logger.log_image(key='predicted mask', images=[
