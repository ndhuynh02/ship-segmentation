...
from src.data.CaM_airbus.components.CaM_airbus import CaMAirbusDataset
from src.data.CaM_airbus.components.transform_CaM_airbus import TransformCaMAirbus


class CaMAirbusDatamodule(LightningDataModule):
    def __init__(
        self,
    ...
    def setup(self, visualize_dist=False, stage: Optional[str] = None):
        ...
        if not self.data_train and not self.data_val and not self.data_test:
            ...
            self.data_train = TransformCaMAirbus(self.data_train, self.hparams.transform_train)
            self.data_val = TransformCaMAirbus(self.data_val, self.hparams.transform_val)
            self.data_test = TransformCaMAirbus(self.data_test, self.hparams.transform_val)
