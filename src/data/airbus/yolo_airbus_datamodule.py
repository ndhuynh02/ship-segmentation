...
from data.airbus.components.yolo_airbus import YoloAirbus
from src.utils.airbus_utils import imshow_batch


class YoloAirbusDataModule(LightningDataModule):
    ...
    def setup(self, visualize_dist=False, stage: Optional[str] = None):
        ...
        if not self.data_train and not self.data_val and not self.data_test:
            ...
            self.data_train = YoloAirbus(self.data_train, self.hparams.transform_train)
            self.data_val = YoloAirbus(self.data_val, self.hparams.transform_val)
            self.data_test = YoloAirbus(self.data_test)
