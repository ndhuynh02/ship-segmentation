...
from src.utils.airbus_utils import get_boxes, rotate_nms, mask_overlay, midpoint2corners, download_checkpoint
...
def ship_segmenter(image, predict_type='instance'):
    ...
    return mask_overlay(image, instance_mask), str(len(result_masks))
